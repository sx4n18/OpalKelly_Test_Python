#########################################################################
## This is to test the third scan of the design example. The design example has the following endpoints:
## WireIn 0x00
## [11:0]  PARA_FEED
## [12]    PARAIN_EN
## [13]    OK_SCAN_IN
...
result = dev.ConfigureFPGA("Top_SCAN_w_LVDS.bit")
